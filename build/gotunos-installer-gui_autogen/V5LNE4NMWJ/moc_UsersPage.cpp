...
void UsersPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->addUserRow(); break;
        case 1: _t->removeUserRow((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->syncSamePassword(); break;
        default: ;
        }
    }
}
