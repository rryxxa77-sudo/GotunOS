/****************************************************************************
** Meta object code from reading C++ file 'ProgressPage.h'
**
...
#include "../../../src/pages/ProgressPage.h"
...
#error "The header file 'ProgressPage.h' doesn't include <QObject>."
...
void ProgressPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->installFinished(); break;
        case 1: _t->onStep((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ProgressPage::*)()>(_a, &ProgressPage::installFinished, 0))
            return;
    }
}
...
// SIGNAL 0
void ProgressPage::installFinished()
{
