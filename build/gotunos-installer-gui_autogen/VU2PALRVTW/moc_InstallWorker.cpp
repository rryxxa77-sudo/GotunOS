...
#include "../../../src/backend/InstallWorker.h"
...
void InstallWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (InstallWorker::*)(const QString & )>(_a, &InstallWorker::stepStarted, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (InstallWorker::*)(const QString & )>(_a, &InstallWorker::logLine, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (InstallWorker::*)(int )>(_a, &InstallWorker::progressChanged, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (InstallWorker::*)(bool , const QString & )>(_a, &InstallWorker::finished, 3))
            return;
    }
}
...
// SIGNAL 0
void InstallWorker::stepStarted(const QString & _t1)
{
...
// SIGNAL 2
void InstallWorker::progressChanged(int _t1)
{
